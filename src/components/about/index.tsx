...
const About = () => {
  return (
    <section id="about" className="mt-10">
      ...
      <div className="mx-auto max-w-[1200px] sm:px-6 md:px-[60px] lg:px-0">

       
        <div className="flex items-end gap-4">
          <p className="uppercase font-montserrat font-bold sm:text-[20px] md:text-[32px] lg:text-4xl text-red whitespace-nowrap">
            О нас
          </p>
        ...
        <p className="sm:mt-5 md:mt-9 lg:mt-12 mb-6 font-manrope font-normal sm:text-base md:text-lg text-darktext">
